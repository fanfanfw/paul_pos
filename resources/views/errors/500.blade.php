...
<body class="min-h-screen bg-base-200 font-sans text-base-content antialiased">
    <main class="flex min-h-screen items-center justify-center p-6">
        <section class="w-full max-w-md rounded-3xl border border-base-300 bg-base-100 p-8 text-center shadow-sm">
            <p class="product-code text-xs font-bold text-error">500</p>
            <h1 class="mt-2 text-2xl font-bold">Terjadi kesalahan</h1>
            <p class="mt-3 text-sm text-base-content/65">Sistem sedang bermasalah. Coba lagi sebentar lagi atau kembali ke dashboard.</p>
